    ...
    return(
        <div className='px-5 py-5'>
            <div className='py-5'>
                ...
                <h1 className='text-center text-[30px] px-12'>Evo-Calc es un proyecto increíble que hemos creado para ayudarles a explorar y aprender más sobre matemáticas de una manera divertida y sencilla.</h1>
            </div>
            <div className='py-5'>
                ...
                <ul className='xl:flex py-5'>
                    <li className='xl:w-1/2 px-4'>
                        ...
                        <button className='rounded-xl bg-[rgb(27,41,55)] m-4 p-4 text-white'>Calculadora de Derivadas</button>
                        </div>
                    </li>
                    <li className='xl:w-1/2 px-5 '>
                        <div className='text-[25px] text-center py-4'>Calculadora de Derivadas 📐</div>
                        ...
                        <div><div><iframe src="https://giphy.com/embed/zPbnEgxsPJOJSD3qfr" width="100%" height="100%"  frameBorder="0"  allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/jk-maru-marujon-zPbnEgxsPJOJSD3qfr"></a></p></div>
                        <div className='text-center '>
                        <button className='rounded-xl bg-[rgb(27,41,55)] m-4 p-4 text-white'>Calculadora de Derivadas</button>
                        </div>
                    </li>
